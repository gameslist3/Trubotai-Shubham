...
export const products: Record<string, ProductData> = {
  ...
  "all-assets-bundle": {
    ...
    tagline: "Everything we offer — all digital assets in one complete bundle at a fraction of the price.",
    description: "Complete bundle of every digital asset in our marketplace at a massive discount. Get everything in one download.",
    ...
    price: 100,
    icon: Gift,
    features: ["Every digital asset included", "Massive discount vs. individual prices", "Complete template library", "All database assets", "All strategy frameworks", "One single download"],
    whatsIncluded: ["All marketplace digital assets", "All templates & frameworks", "All databases & datasets", "All strategy packs", "Complete documentation library", "Lifetime access to all future updates"],
    keyBenefits: ["Everything in one bundle", "90%+ savings vs. individual purchase", "Complete business toolkit", "Lifetime access to all assets", "All future updates included", "One-time purchase, use forever"],
    ...
    deliverables: ["Complete asset library", "Master index document", "Bundle delivery guide"],
